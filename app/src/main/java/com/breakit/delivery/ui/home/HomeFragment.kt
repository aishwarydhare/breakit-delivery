...
import com.breakit.delivery.databinding.FragmentHomeBinding
...
class HomeFragment : DaggerFragment() {
    ...
    private fun initView() {
        ...
        deliveryAdapter = DeliveryAdapter(
            ...
            handleOnAbortClick = { indexClicked, reason ->
                val order = homeViewModel.todaysDeliveries.value!![indexClicked]
                homeViewModel.abortDelivery(order, reason, activity = activity as MainActivity)
            }
        )
